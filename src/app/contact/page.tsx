  ...
  <div className="container px-5 py-24 mx-auto">
    ...
    <h1 className="text-[35] font-serif font-extrabold sm:text-6xl text-3xl mb-4 text-gray-100 md:mt-2 md:ml-[90px]">
      ...
      <p className="lg:w-2/3 mx-auto leading-relaxed text-gray-100">
       I am Frontend Developer and Graphic Designer Feel free to contact me to design any thing
      </p>
    </div>
    <div className="lg:w-1/2 md:w-2/3 mx-auto ">
      <div className="flex flex-wrap -m-2">
        ...
        <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
          ...
          <li>
            <a href="https://github.com/"className=" text-gray-100  hover:text-2xl  hover:text-gray-900"> <FaGithub className="  hover:text-blue-500"/></a>
          </li>
          <li>
            <a href="www.linkedin.com/in/siddiqa-badar-49a5692b5"className="text-gray-100  hover:text-2xl  hover:text-gray-900"> <CiLinkedin className=" hover:text-blue-500"/></a>
          </li>
          <li>
            <a href="www.linkedin.com/in/siddiqa-badar-49a5692b5"className="text-gray-100  hover:text-2xl  hover:text-gray-900"> <FaFacebookF className=" hover:text-blue-500"/></a>
          </li>
          <li>
            <a href="https://www.behance.net/siddiqa04"className="text-gray-100  hover:text-2xl  hover:text-gray-900"> <FaBehance className=" hover:text-blue-500"/></a>
          </li>
