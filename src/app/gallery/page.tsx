    ...
    <div>
        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-20">
            ...
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base text-gray-100">
              As a web developer, I build responsive, user-friendly websites
              that are both visually captivating and technically robust. My
              expertise in modern web technologies like HTML5, CSS3, JavaScript,
              and frameworks like React and Nextjs ensures that my projects are
              ...
              <div className="flex relative">
                ...
                <div className="px-8 py-10 relative z-10 w-full border-4 border-blue-500 bg-blue-100 opacity-0 hover:opacity-100">
                  ...
                  <p className="leading-relaxed text-gray-900">
                    I build this page by HTML5 and CSS as a project. Its great
                    experience for my learning period.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:w-1/3 sm:w-1/2 p-4 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 ...">
              <div className="flex relative">
                ...
                <div className="px-8 py-10 relative z-10 w-full border-4 border-blue-500 bg-blue-100 opacity-0 hover:opacity-100">
                  ...
                  <p className="leading-relaxed text-gray-900">
                    This is my unique and beautiful registration form page which
            ...
            <div className="lg:w-1/3 sm:w-1/2 p-4 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 ...">
              <div className="flex relative">
                ...
                <div className="px-8 py-10 relative z-10 w-full border-4 border-blue-500 bg-blue-100 opacity-0 hover:opacity-100">
                  ...
                  <p className="leading-relaxed text-gray-900">
                    This is Amazing creativity of my learning skill which is
                    target for me to build.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:w-1/3 sm:w-1/2 p-4 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 ...">
              <div className="flex relative">
                ...
                <div className="px-8 py-10 relative z-10 w-full border-4  border-blue-500 bg-blue-100 opacity-0 hover:opacity-100">
                  ...
                  <p className="leading-relaxed text-gray-900">
                    This is Daraz Clone which was more chellenging to me and my
                    development.
                  </p>
                </div>
              </div>
            ...
            <div className="lg:w-1/3 sm:w-1/2 p-4 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 ...">
              <div className="flex relative">
                ...
                <div className="px-8 py-10 relative z-10 w-full border-4  border-blue-500 bg-blue-100 opacity-0 hover:opacity-100">
                  ...
                  <p className="leading-relaxed text-gray-900">
                    This is an another project of JavaScript which is fully
            ...
            <div className="lg:w-1/3 sm:w-1/2 p-4 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 ...">
              <div className="flex relative">
                ...
                <div className="px-8 py-10 relative z-10 w-full border-4  border-blue-500 bg-blue-100 opacity-0 hover:opacity-100">
                  ...
                  <p className="leading-relaxed text-gray-900">
                    This is Facebook Signin Page with fully functionality of
            ...
            <div className="lg:w-1/3 sm:w-1/2 p-4 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 ...">
              <div className="flex relative">
                ...
                <div className="px-8 py-10 relative z-10 w-full border-4  border-blue-500 bg-blue-100 opacity-0 hover:opacity-100">
                  ...
                  <p className="leading-relaxed text-gray-900">
                    It is a stop watch which has fully organized with
                    functionalty of JavaScript.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:w-1/3 sm:w-1/2 p-4 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 ...">
              <div className="flex relative">
                ...
                <div className="px-8 py-10 relative z-10 w-full border-4  border-blue-500 bg-blue-100 opacity-0 hover:opacity-100">
                  ...
                  <p className="leading-relaxed text-gray-900">
                    This is my project of 14th August Website with
                    functionality.
                  </p>
                </div>
              </div>
            ...
            <div className="lg:w-1/3 sm:w-1/2 p-4 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 ...">
              <div className="flex relative">
                ...
                <div className="px-8 py-10 relative z-10 w-full border-4  border-blue-500 bg-blue-100 opacity-0 hover:opacity-100">
                  ...
                  <p className="leading-relaxed text-gray-900">
                    This is my another craetive webpage design which is made by
                    HTML5 and CSS3 to see status of delivery .
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container px-5 py-24 mx-auto flex flex-wrap">
          <div className="flex w-full mb-20 flex-wrap">
            ...
            <p className="lg:pl-6 lg:w-2/3 mx-auto leading-relaxed text-gray-100">
              My graphic design projects reflect my commitment to crafting
              visually compelling and effective designs that resonate with
              audiences and elevate brand identities. Each project is a
              testament to my ability to blend creativity with strategic
              thinking, ensuring that the final product not only looks stunning
          ...
          <div className="flex flex-wrap md:-m-2 -m-1">
            <div className="flex flex-wrap w-1/2">
              ...
              <div className="md:p-2 p-1 w-full">
                <img
                  alt="Egyptian"
                  className="w-full h-full object-cover object-center block border-8 border-gray-700 rounded-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 lg:w-[600px] lg:[250px] lg:ml-20"
      ...
      <div className="flex flex-col text-center w-full mb-20">
        ...
        <p className="lg:w-2/3 mx-auto leading-relaxed">
          My Video Editing skills are grounded in a deep understanding of both
          technical tools and creative concepts, allowing me to transform raw
          footage into polished, impactful content.
        </p>
      </div>
      <div className="lg:ml-[280px] mb-[200px] sm:ml-[110px]">
        <video
          className=" lg:h-[20%] lg:w-[75%] rounded-3xl border-8 border-gray-100"
          controls
          autoPlay
          muted
        >
